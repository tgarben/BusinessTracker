...
- **Done (2026-06-21):** `TimerAppBadge` renders the `freelancedLogo` asset (copied into `FreelancedWidget/Assets.xcassets` so the extension target can load it).
